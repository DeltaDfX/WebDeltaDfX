...
const appRoutes: Routes = [
  ...
  {path: 'company-dashboard', component: CompanyDashboardComponent, canActivate: [NeedAuthGuard]},
  {path: 'register', component: RegisterComponent},
  {path: 'management/:view', component: ManagementPageComponent, canActivate: [NeedAuthGuard]},
  {path: 'management', component: ManagementPageComponent, canActivate: [NeedAuthGuard]},
  {path: 'management/list-stakeholder', component: ListStakeholderComponent, canActivate: [NeedAuthGuard]},
  {path: 'survey/:token', component: SurveyPageComponent},
  {path: 'management/createSurvey', component: EditSurveyComponent, canActivate: [NeedAuthGuard]},
  {path: 'management/surveys', component: SurveyMainPageComponent, canActivate: [NeedAuthGuard]},
